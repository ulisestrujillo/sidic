...
<title>SIDIC - Administra tus ordenes de compra</title>
<!-- Favicon-->
...
<div class="page-loader-wrapper">
    ...
    <div class="line"></div>
        <p>Please wait...</p>
        <div class="m-t-30"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/images/logo.svg" width="48" height="48" alt="Nexa"></div>
    </div>
</div>
...
<aside id="leftsidebar" class="sidebar">
    ...
    <div class="user-info">
        <div class="image">
            <img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/images/xs/avatar1.jpg" width="48" height="48" alt="User" />
        </div>
        ...
        <div class="body">
            ...
            <ul class="chat-scroll-list clearfix">
                <li class="left float-left">
                    <img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/images/xs/avatar3.jpg" class="rounded-circle" alt="">
                    <div class="chat-info">
                ...
                <li class="left float-left"> <img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/images/xs/avatar2.jpg" class="rounded-circle" alt="">
                ...
                <li class="left float-left"> <img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/images/xs/avatar1.jpg" class="rounded-circle" alt="">
                        ...
                        <ul class="inbox-widget list-unstyled clearfix">
                            <li class="inbox-inner"> <a href="#">
                                <div class="inbox-item">
                                    <div class="inbox-img"> <img src="http://via.placeholder.com/50x50" alt=""> </div>
                    ...
                    <div class="body table-responsive members_profiles">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <img class="rounded-circle" src="http://via.placeholder.com/40x40" alt="user" width="40"> </td>
                                    <td>

...
<table width="100%" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td width="30%"><h1><img width="100px" src="<?php echo $logo; ?>" border="0" /></h1></td>
		<td width="40%"><h1>&Oacute;rden de compra</h1></td>
		<td width="30%">
...
<table width="100%" cellpadding="0" cellspacing="0">
  <tr>
	...
	<tr style="color: #02029e;">
		...
		<td width="7%"><strong>Unidad</strong></td><!-- unidad -->
...
?>
	<tr>
		...
		<td width="7%"><?php echo $det->unit; ?></td><!-- unidad -->
		<td width="45%">&nbsp;&nbsp;
...
<?php } ?>  
	...
	<tr>
		<td width="5%"></td><!-- unidad -->
		<td width="7%" style="text-align: right;">
		</td><!-- concepto -->
		<td width="45%" style="text-align: right;"><strong>Totales:&nbsp;&nbsp;&nbsp;</strong></td><!-- unidad -->
  ...
  <tr>
  	<td colspan="7"><br/><br/><br/><strong>Total en letra:</strong> 
...
<table width="100%" cellpadding="0" cellspacing="0">
  ...
  <tr>
  	...
  	<td width="33.3333%" style="text-align: center"><?php echo $colocadaPor; ?></td><!-- nombre del que imprime la orden -->
  	<td width="33.3333%" style="text-align: center"></td><!-- nombre de quien coloca -->
  </tr>
  <tr>

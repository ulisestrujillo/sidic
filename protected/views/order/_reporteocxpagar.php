...
//"page":1,"total":3,"records":20,"rows":
    ...
    var _url='<?php echo Yii::app()->createUrl('order/reporteocporpagardata')."&projectid=".$project->id."&budgetid=".$budgetid."&page=1"; ?>';
    ...
    $("#jqGrid").jqGrid({
      ...
      datatype: "json",
      page: 1,
      colNames: ['Folio', 'Partida', 'Subpartida', 'Proveedor', 'Monto', 'Fecha Pagar'],
      ...
      colModel: [
        ...
        { name: 'FechaParaPagar', key: false, width: 20, search:false, align:'right' },
      ],
      loadonce: true,
      autowidth:true,
      height: 600,
    ...
    $('#jqGrid').jqGrid('navGrid',"#jqGridPager", {                
      ...
      onClickButton: function() {
        window.open("<?php echo Yii::app()->createUrl('order/reporteocporpagarpdf')."&projectid=".$project->id."&budgetid=".$budgetid."&page=1"; ?>",'_blank');
      }
    });

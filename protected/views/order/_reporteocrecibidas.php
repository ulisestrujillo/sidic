...
//"page":1,"total":3,"records":20,"rows":
    ...
    var _url='<?php echo Yii::app()->createUrl('order/reporteocrecibidasdata')."&projectid=".$project->id."&budgetid=".$budgetid."&page=1"; ?>';
    ...
    $("#jqGrid").jqGrid({
      ...
      datatype: "json",
      page: 1,
      colNames: ['Folio', 'Partida', 'Subpartida', 'Proveedor', 'Monto', 'Recibida','Tope Presupuesto'],
      ...
      colModel: [
        ...
        { name: 'Recibida', key: false, width: 15, search:false },
    ...
    $('#jqGrid').jqGrid('navGrid',"#jqGridPager", {                
      ...
      onClickButton: function() {
        window.open("<?php echo Yii::app()->createUrl('order/reporteocrecibidaspdf')."&projectid=".$project->id."&budgetid=".$budgetid."&page=1"; ?>",'_blank');
      }
    });

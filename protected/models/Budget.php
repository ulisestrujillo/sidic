...
class Budget extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, projectid, created, update', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'budgetitems' => array(self::HAS_MANY, 'BudgetItem', 'budgetid'),
			'orders' => array(self::HAS_MANY, 'Order', 'budgetid'),
		);
	}
